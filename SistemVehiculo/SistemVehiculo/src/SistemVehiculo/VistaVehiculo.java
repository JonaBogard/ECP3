...
public class VistaVehiculo {
	...
	private void initialize() {
		...
		btnActualizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					nv.setColor(txtColor.getText());
					nv.setTipo(txtTipo.getText());
					if (nv.actualizarVehiculo()) {
						limpiar();
						JOptionPane.showMessageDialog(null, "Datos del vehiculo actualizados");
					} else {
		...
		btnCargar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String VehiculoId = JOptionPane.showInputDialog("ID de la orden");
					NegocioVehiculo nv = new NegocioVehiculo();
					nv.setVehiculoId(VehiculoId);
